...
const CreateOffer = () => {
  ...
  const handleCreateWish = async (values: formValues) => {
    const {item} = values;
            ...
            <Layout>
              <Content>
                <Form
                  ...
                  layout="vertical"
                  onFinish={handleCreateWish}
                  form={form}
                >
                  <Form.Item hidden name={["item", "acao"]} initialValue="P" />
                  <div className={styles.column}>
                    ...
                    >
                      <Input placeholder="O que você está pedindo?" />
                    </Form.Item>
                    <Form.Item
                      name={["item", "descricao"]}
                      ...
                      >
                        <Upload.Dragger name="files" action="/upload.do">
                          ...
                          <p className="ant-upload-hint">
                            ...
                            mais quem está oferecendo este item.
                          </p>
                        </Upload.Dragger>
                      </Form.Item>
                    </Form.Item>
